...
import com.fcore.contract.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.fcore.contract.domain.Contract}.
 */
@RestController
@RequestMapping("/api")
public class ContractResource {
    ...
    private static final String ENTITY_NAME = "contractContract";
