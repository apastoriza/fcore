...
import static com.fcore.contract.web.rest.TestUtil.createFormattingConversionService;
...
public class ContractResourceIT {
    ...
    public void createContract() throws Exception {
        ...
        assertThat(testContract.getDocumentNumber()).isEqualTo(DEFAULT_DOCUMENT_NUMBER);
        assertThat(testContract.isEnabled()).isEqualTo(DEFAULT_ENABLED);
    }
    ...
    public void checkDocumentNumberIsRequired() throws Exception {
        ...
        // set the field null
        contract.setDocumentNumber(null);
    ...
    public void updateContract() throws Exception {
        ...
        Contract testContract = contractList.get(contractList.size() - 1);
        assertThat(testContract.getDocumentNumber()).isEqualTo(UPDATED_DOCUMENT_NUMBER);
        assertThat(testContract.isEnabled()).isEqualTo(UPDATED_ENABLED);
    }
