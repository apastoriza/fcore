...
import { ContractDeleteDialogComponent } from 'app/entities/contract/contract/contract-delete-dialog.component';
import { ContractService } from 'app/entities/contract/contract/contract.service';
