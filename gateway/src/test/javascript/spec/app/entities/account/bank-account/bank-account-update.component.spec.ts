...
import { BankAccountUpdateComponent } from 'app/entities/account/bank-account/bank-account-update.component';
import { BankAccountService } from 'app/entities/account/bank-account/bank-account.service';
import { BankAccount } from 'app/shared/model/account/bank-account.model';
