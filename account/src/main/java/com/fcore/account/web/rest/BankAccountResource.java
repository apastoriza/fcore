...
import com.fcore.account.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.fcore.account.domain.BankAccount}.
 */
@RestController
@RequestMapping("/api")
public class BankAccountResource {
    ...
    private static final String ENTITY_NAME = "accountBankAccount";
